...
public class EmployeeInheritance {
    public static void main(String[] args) {
        Employee[] employees = {
            new Employee("E01", "Plain", 40000),
            new ManagerEmployee("E02", "Manager", 70000, 8000),
            new InternEmployee("E03", "Intern", 12000, 10000)
        };
...
class ManagerEmployee extends Employee {
    ...
    ManagerEmployee(String id, String name, double salary, double bonus) { super(id, name, salary); this.teamBonus = bonus; }
    double effectiveSalary() { return getSalary() + teamBonus; }
}

class InternEmployee extends Employee {
    private final double stipendCap;
    InternEmployee(String id, String name, double salary, double cap) { super(id, name, salary); this.stipendCap = cap; }
